...
Class class_upcoming_event_volunteer_widget extends \WP_Widget{
    ...
    public function __construct() {
        parent::__construct(
            'upcoming_event_volunteer_widget',
            __('Upcoming volunteer Events', 'ultimate-event-manager'),
            ['description' => __('Displays upcoming events for Volunteer.', 'ultimate-event-manager')]
        );
    }
