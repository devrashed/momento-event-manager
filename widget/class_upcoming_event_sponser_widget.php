...
class class_upcoming_event_sponser_widget extends \WP_Widget{

    public function __construct() {
        parent::__construct(
            'upcoming_event_sponser_widget',
            __('Upcoming Sponsers Events', 'ultimate-event-manager'),
            ['description' => __('Displays upcoming events for Sponsers.', 'ultimate-event-manager')]
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if ($events) {
            ...
            foreach ($events as $event) {
                ...
                // Get organizer
                $organizer = get_post_meta($event->ID, 'wtmem_event_sponsa_name', true);
