    ...
    public function widget( $args, $instance ) {
        ...
        <div class="contact-info">
          ...
          <!-- <p><strong>Address:</strong> <?php echo esc_html($instance['address']); ?></p>
            <p><strong>city:</strong> <?php echo esc_html($instance['city']); ?></p>
            <p><strong>State:</strong> <?php echo esc_html($instance['state']); ?></p>
            <p><strong>zip code:</strong> <?php echo esc_html($instance['zip']); ?></p>
            <p><strong>Country:</strong> <?php echo esc_html($instance['country']); ?></p> -->
