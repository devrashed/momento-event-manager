			...
			<!-- <table class="uem-tickets-table">
				<thead>
					<tr>
						...
						<th><?php echo esc_html( 'Price', 'mega-events-manager' ); ?></th>
						<th><?php echo esc_html( 'Quantity', 'mega-events-manager' ); ?></th>
						<th><?php echo esc_html( 'Total', 'mega-events-manager' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php foreach ( $tickets as $index => $ticket ) : 
						...
						<tr>
							...
							<td class="uem-ticket-total" data-ticket-index="<?php echo esc_attr( $index ); ?>"><?php echo wc_price( $ticket['price'] * $cart_quantity ); ?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="3" style="text-align: right;"><strong><?php echo esc_html( 'Grand Total:', 'mega-events-manager' ); ?></strong></td>
						<td class="uem-grand-total"><strong><?php 
							...
							foreach ( $tickets as $index => $ticket ) {
								...
								$grand_total += $ticket['price'] * $cart_quantity;
							}
	...
	<div class="uem-simple-registration">
		<form id="uem-registration-form" method="post">
			...
			<div class="uem-registration-details">
				<h3><?php echo esc_html__( 'Your Details', 'mega-events-manager' ); ?></h3>
					<p>
						<label for="uem_registration_name"><?php echo esc_html__( 'Name', 'mega-events-manager' ); ?> <span class="required">*</span></label>
						<input type="text" name="uem_registration_name" id="uem_registration_name" required>
					</p>
					<p>
						<label for="uem_registration_phone"><?php echo esc_html__( 'Phone', 'mega-events-manager' ); ?> <span class="required">*</span></label>
						<input type="tel" name="uem_registration_phone" id="uem_registration_phone" required>
					</p>
					<p>
						<label for="uem_registration_email"><?php echo esc_html__( 'Email', 'mega-events-manager' ); ?></label>
						<input type="email" name="uem_registration_email" id="uem_registration_email">
					</p>
					<p>
						<label for="uem_registration_address"><?php echo esc_html__( 'Address', 'mega-events-manager' ); ?></label>
						<textarea name="uem_registration_address" id="uem_registration_address" rows="3"></textarea>
					</p>
			</div>
			
			<div class="uem-ticket-selection">
				<h3><?php echo esc_html__( 'Select Tickets', 'mega-events-manager' ); ?></h3>
				<table class="uem-tickets-table">
					<thead>
                        	<tr>
                        		<th><?php echo esc_html__( 'Ticket Type', 'mega-events-manager' ); ?></th>
                        		<th><?php echo esc_html__( 'Price', 'mega-events-manager' ); ?></th>
                        		<th><?php echo esc_html__( 'Available', 'mega-events-manager' ); ?></th>
                        		<th><?php echo esc_html__( 'Quantity', 'mega-events-manager' ); ?></th>
                        		<th><?php echo esc_html__( 'Total', 'mega-events-manager' ); ?></th>
                        	</tr>
					</thead>
					<tbody>
						<?php foreach ( $tickets as $index => $ticket ) : ?>
					...
					<tfoot>
						<tr>
							<td colspan="4" style="text-align: right;"><strong><?php echo esc_html__( 'Grand Total:', 'mega-events-manager' ); ?></strong></td>
			...
			<div class="uem-attendee-details" id="uem-attendee-details" style="display: none;">
				<h3><?php echo esc_html__( 'Attendee Details', 'mega-events-manager' ); ?></h3>
				<div id="uem-attendee-fields"></div>
			</div>
			
			<p>
				<button type="submit" name="uem_registration_submit" class="button uem-submit-registration">
					<?php echo esc_html__( 'Submit Registration', 'mega-events-manager' ); ?>
				</button>
			</p>
		</form>
	</div>
