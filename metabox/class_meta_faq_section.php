...
class class_meta_faq_section {
    ...
    public function wtmem_faq_fields($post) {
        ...
        <label><strong><?php echo esc_html__('Display FAQ?', 'momento-event-manager') ?></strong></label> 
        ...
        <p><?php echo esc_html__('If you want to display FAQ please check this Yes', 'momento-event-manager') ?></p>
        ...
        <div class="faq_wrapper">
                        ...
                        <li class="faq_timeline-item">
                            <div class="faq_timeline-top">
                                <button type="button" class="faq_btn faq_btn-expand">
                                   <span class="dashicons dashicons-arrow-down-alt2"></span> <?php echo esc_html__('Expand', 'momento-event-manager'); ?>
                                </button>
            ...
            <button type="button" id="faq_addTimeline" class="faq_add-timeline">
               <span class="dashicons dashicons-plus"></span> <?php echo esc_html__('Add New F.A.Q', 'momento-event-manager'); ?>
            </button>
        </div>
        <?php
    }
    ...
    // Save meta
    public function wtmem_save_meta_faq_details($post_id) {
